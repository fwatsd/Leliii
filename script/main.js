...
.call(() => {
  ...
  if (btn) {
    ...
    btn.addEventListener("click", function () {
      Swal.fire({
        title: 'Pertanyaan buat kamu 😋',
        html: '<strong>Mau nggak kita ubah status dari temen jadi kita? 💞</strong><br><em>(jangan lupa di-skrinsut jawabannya yaa 😆)</em>',
        icon: 'question',
        showCancelButton: true,
        confirmButtonText: 'Mauu banget! 😍',
